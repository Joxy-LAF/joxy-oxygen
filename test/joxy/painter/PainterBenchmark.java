...
public class PainterBenchmark {
	...
	public void benchmarkButtonSlab() {
		...
		for (int i = 0; i < 100; i++) {
			ButtonSlabPainter.paint(g2, 0, 0, 400, 400);
		}
	...
	public void benchmarkDarkEngraving() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			DarkEngravingPainter.paint(g2, 0, 0, 400, 400);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkFocusIndicator() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			FocusIndicatorPainter.paint(g2, 0, 0, 400, 400, 128);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkHoverIndicator() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			HoverIndicatorPainter.paint(g2, 0, 0, 400, 400, 128);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkInputField() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			InputFieldPainter.paint(g2, 0, 0, 400, 400);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkMenuItemBackground() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			MenuItemBackgroundPainter.paint(g2, 0, 0, 400, 400, 128);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkPressedButtonSlab() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			PressedButtonSlabPainter.paint(g2, 0, 0, 400, 400);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkProgressBarIndicator() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			ProgressBarIndicatorPainter.paint(g2, 0, 0, 400, 400);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkRoundButtonSlab() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			RoundButtonSlabPainter.paint(g2, 0, 0, 400, 400);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkRoundFocusIndicator() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			RoundFocusIndicatorPainter.paint(g2, 0, 0, 400, 400, 128);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkRoundHoverIndicator() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			RoundHoverIndicatorPainter.paint(g2, 0, 0, 400, 400, 128);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkScrollThumb() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			ScrollThumbPainter.paint(g2, 0, 0, 400, 400, 128);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkTextFieldFocusIndicator() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			TextFieldFocusIndicatorPainter.paint(g2, 0, 0, 400, 400, 128);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkTextFieldHoverIndicator() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			TextFieldHoverIndicatorPainter.paint(g2, 0, 0, 400, 400, 128);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
	...
	public void benchmarkToolbarHoverIndicator() {
		long beforeTime = System.nanoTime();
		for (int i = 0; i < 100; i++) {
			ToolbarHoverIndicatorPainter.paint(g2, 0, 0, 400, 400, 128);
		}
		long afterTime = System.nanoTime();
		Output.print(((afterTime - beforeTime) / 100000) / 1000f + " ms per draw.");
	}
