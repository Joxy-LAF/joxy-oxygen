...
/**
 * Joxy's UI delegate for the JFormattedTextField.
 * 
 * <p>The JoxyFormattedTextFieldUI supports animations for the focus and hovered states.
...
public class JoxyFormattedTextFieldUI extends BasicFormattedTextFieldUI {
	...
	public static ComponentUI createUI(JComponent c) {
		c.setOpaque(false);
		return new JoxyFormattedTextFieldUI(c);
	}

	public JoxyFormattedTextFieldUI(JComponent c) {
