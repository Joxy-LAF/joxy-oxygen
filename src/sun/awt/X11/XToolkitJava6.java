...
//
//import joxy.kde.JoxyTrayIconPeer;
...
//public class XToolkitJava6 extends UNIXToolkit implements Runnable, XConstants {
...
//        awtLock();
//        try {
//            long res = XlibWrapper.RootWindow(XToolkitJava6.getDisplay(),
//                XlibWrapper.DefaultScreen(XToolkitJava6.getDisplay()));
//
//            if (res == 0) {
...
//            }
//
//            AwtScreenData defaultScreen = new AwtScreenData(XToolkitJava6.getDefaultScreenData());
//            awt_defaultFg = defaultScreen.get_blackpixel();
//
//            arrowCursor = XlibWrapper.XCreateFontCursor(XToolkitJava6.getDisplay(),
...
//            {
//                Rectangle workArea = XToolkitJava6.getWorkArea(root);
//                if (workArea != null)
//                {
...
//		// JOXY-EDIT
//    	TrayIconPeer peer = new JoxyTrayIconPeer(target);
//        targetCreatedPeer(target, peer);
//        return peer;
//    }
//
...
//        try {
//            try {
//                String multiclick_time_query = XlibWrapper.XGetDefault(XToolkitJava6.getDisplay(), "*", "multiClickTime");
...
//                } else {
//                    multiclick_time_query = XlibWrapper.XGetDefault(XToolkitJava6.getDisplay(),
...
//            try {
//                if (!initialized) {
//                    XToolkitJava6.addEventDispatcher(XBaseWindow.getXAWTRootWindow().getWindow(),
//                                                timeFetcher);
//                    _XA_JAVA_TIME_PROPERTY_ATOM = XAtom.get("_SUNW_JAVA_AWT_TIME");
//                    initialized = true;
//                }
//                timeStampUpdated = false;
//                XlibWrapper.XChangeProperty(XToolkitJava6.getDisplay(),
//                                            XBaseWindow.getXAWTRootWindow().getWindow(),
//                                            _XA_JAVA_TIME_PROPERTY_ATOM.getAtom(), XAtom.XA_ATOM, 32,
//                                            PropModeAppend,
//                                            0, 0);
//                XlibWrapper.XFlush(XToolkitJava6.getDisplay());
//
//                if (isToolkitThread()) {
//                    XEvent event = new XEvent();
//                    try {
//                        XlibWrapper.XWindowEvent(XToolkitJava6.getDisplay(),
//                                                 XBaseWindow.getXAWTRootWindow().getWindow(),
...
//        awtLock();
//        try {
//            return XlibWrapper.XGetPointerMapping(XToolkitJava6.getDisplay(), 0, 0);
//        } finally {
//            awtUnlock();
//        }
//    }
...
//        return XToolkitJava6.getBackingStoreType() == XConstants.NotUseful;
//    }
//
//    /**
